...
public class Sample1Controller {
    ...
    @RequestMapping("sample.do") // 샘플 화면 컨트롤러
    public String sample(Model model){
        logger.info("sample called...."); // 로그 출력
 
        return "sample/sample"; // doB.jsp로 포워드
    }
    
    
    @RequestMapping("doA.do") // url pattern
    ...
    @RequestMapping("doB.do") // url pattern
    public void doB(){
    ...
    @RequestMapping("doC.do") // url pattern
